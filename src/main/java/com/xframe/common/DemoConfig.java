...
import com.xframe.common.model._MappingKit;
import com.xframe.router.Xrouter;
import com.xframe.tasks.Tasks;
...
public class DemoConfig extends JFinalConfig {
	...
	/**
	 * 先加载开发环境配置，然后尝试加载生产环境配置，生产环境配置不存在时不会抛异常 在生产环境部署时后动创建
	 * demo-config-pro.txt，添加的配置项可以覆盖掉 demo-config-dev.txt 中的配置项
	 */
